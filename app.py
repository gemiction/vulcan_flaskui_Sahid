...
def index():
    ...
    area = playstore['Install'].values/10000000 # ukuran besar/kecilnya lingkaran scatter plot
    ...
    wp= wholepie.iloc[10:20,:].reset_index()
    ...
    plt.title('TOP 10-20 INSTALLED APPS')
    plt.axis('equal')
    plt.savefig('wholepie.png',bbox_inches="tight")
